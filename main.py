...
#---------------------------------------
pygame.init()
fondo_mainmenu = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\rsz_wallpapaer_menu.png")
fondo_salir = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\rsz_dino_end_game.png")
...
class Nube(pygame.sprite.Sprite):
    def __init__(self):
      super().__init__()
      self.image = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\cloud.png")
...
class Enemigo1(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\dragon_verde_mediano.png")
        self.image.set_colorkey(withe)
        self.rect = self.image.get_rect()
        self.speedy = 3
        self.speedx = -3
...
# ----------------------------------------------------------------
play = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\jugar blanco.png")
play_2 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\jugar verde.png")
opcion_1 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\opciones blanco.png")
opcion_2 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\opciones celeste.png")
exit = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\Salir blanco.png")
exit_2 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\Salir rojo.png")
altavoz = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\altavoz.png")
vlmen_arriba = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\mas.png")
vlmen_abajo = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\restar.png")
muted = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\mudo.png")
sonido = pygame.image.load("D:\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\sonido.png")
...
class Player():
    def __init__(self):
        self.Img = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\dragonPlayer1.png")
        self.runImg1 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\dragonPlayer2.png")
        ...
        self.runImg1 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\dragonPlayer1.png")
        self.runImg1.set_colorkey([255, 255, 255]) #antes todo 255
        self.runImg2 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\dragonPlayer2.png")
        ...
        self.duck1 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\dino_ducking1.png")
        self.duck2 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\dino_ducking2.png")
        ...
        self.jump_sound = pygame.mixer.Sound("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sonidos\\jump.wav")
        self.count = 0
        self.jumping = False
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self,x,y):
        super().__init__()
        self.image = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\fuego_sprite.png")
...
class Volcan():
    def __init__(self):
        self.image0 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\cacti-small.png")
        self.image0.set_colorkey([255, 255, 255])
        self.image1 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\cacti-big.png")
...
class Ground():
    def __init__(self):
        ...
        self.image1 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\ground.png")
        self.image1.set_colorkey([255, 255, 255])
        self.image1_x = 0
        self.image1_y = 500
        self.image2 = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\ground.png")
...
def Pause(score_value):
    ...
    check_point = pygame.mixer.Sound("D:\\Documentos owo\\Documentos\\Universidad\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-mastersonidos\\checkpoint.wav")
    death_sound = pygame.mixer.Sound("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-mastersonidos\\die.wav")
    pygame.display.set_caption("Dino Run")
    dino_icon = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\sprites\\dino_.png")

    pygame.display.set_icon(dino_icon)

    game_over = pygame.image.load("sprites\\game_over.png")
    replay_button = pygame.image.load("sprites\\replay_buton.png")
    logo = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\sprites\\logo.png")
    GREY = (240, 240, 240)
    WHITE = (255, 255, 255)
    GREEN = (0, 255, 0)
    BLACK = (0, 0, 0)
...
## CREACION DE DIFICULTAD - velocidad
        if int(score_value) % 100 == 0 and int(
            ...
            if score_value > 1 and score_value % 100 == 0:  # SONIDO DE CHECK POINT AL LLEGAR A SCORE 100
                check_point.play()

            closest_hitbox = min(volcan.hitbox0, volcan.hitbox1, volcan.hitbox2)

            if player.hitbox.colliderect(closest_hitbox):  # COLICION CON VOLCAN
                death_sound.play()
                dead = True
...
running = True
def main_menu():
    sonido = pygame.mixer.Sound('D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sonidos\\x.wav')
    menu_sound = pygame.mixer.music.load('D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sonidos\\02 - Cloud Country.mp3')
    ...
    while running:
        ...
        click = False
        # Bucle del Juego, aca es donde se capturan Todos los Eventos
...
def Game():
    fondo = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\fondo.png")
    fondo_juego = pygame.transform.scale(fondo, (800, 600))
    screen = pygame.display.set_mode((800, 600))
    clock = pygame.time.Clock()
    font = pygame.font.Font("freesansbold.ttf", 20)
    check_point = pygame.mixer.Sound("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sonidos\\checkpoint.wav")
    death_sound = pygame.mixer.Sound("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sonidos\\die.wav")
    pygame.display.set_caption("Dino Run")
    dino_icon = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\dino_.png")

    pygame.display.set_icon(dino_icon)

    game_over = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\game_over.png")
    replay_button = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\deplay.png")
    logo = pygame.image.load("D:\\Documentos owo\\Documentos\\Universidad\\Seminarios de Lenguajes\\Codigo\\TP Final\\Juego-master\\sprites\\logo.png")
    GREY = (240, 240, 240)
    WHITE = (255, 255, 255)
    GREEN = (0, 255, 0)
    BLACK = (0, 0, 0)
