...
fondo_final_win = pygame.image.load("Juego\\sprites\\wiin.png")
...
Background_fondo_final = Background(fondo_final, [0, 0])
Background_win = Background(fondo_final_win, [0,0])
# ----------------------------------------------------------------
